...
def main():
    ...
    # Probability that the team scores more than 5.5 goals?
    prob_more_than_5_5 = np.mean(future_goals_sim > 5.5)
    print(f"Probability of more than 5.5 goals: {prob_more_than_5_5:.4f}")

    # Probability that the team scores less than 5.5 goals?
    prob_less_than_5_5 = np.mean(future_goals_sim < 5.5)
    print(f"Probability of less than 5.5 goals: {prob_less_than_5_5:.4f}")
